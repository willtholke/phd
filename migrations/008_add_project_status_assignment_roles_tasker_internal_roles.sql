...
UPDATE taskers SET internal_roles = '{tasker,team_lead}' WHERE id = 13;               -- James Wilson (senior quant)
UPDATE taskers SET internal_roles = '{tasker,reviewer,team_lead}' WHERE id = 18;      -- Eleanor (experienced professor)
